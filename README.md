...
You connected a Spring AI agent to the Infobip Message MCP server, authenticated the connection with an API key, and exposed the MCP tools to the model through Spring AI. The model can now turn a natural-language request into a real SMS.
